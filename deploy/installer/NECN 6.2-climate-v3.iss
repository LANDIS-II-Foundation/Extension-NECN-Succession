...
#define AppVersion "6.2.1-climate-v3"
...
Source: {#BuildDir}\Landis.Extension.Succession.NECN-v6.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "NECN_Succession 6.2.txt"
