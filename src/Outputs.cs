    ...
    public class Outputs
    {
        ...
        public static void WriteMonthlyLogFile(int month)
        {
         ...
         public static void WriteMaps()
         {
            ...
            string pathH2O = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "Annual-water-budget-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
            ...
            string pathANPP = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "AG_NPP-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
            ...
            string path = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "SOMTC-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
            ...
            string path2 = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "SoilN-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
            ...
            string path4 = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "ANEE-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
            ...
            string path5 = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "TotalC-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
            ...
            string pathLAI = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "LAI-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
            ...
            string pathavailablewater = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "AvailableWater-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
            ...
            if (PlugIn.Parameters.SmokeModelOutputs)
            {
                ...
                string pathDWD = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "DeadWoodBiomass-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
                ...
                string pathLitter = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "SurfaceLitterBiomass-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
                ...
                string pathDuff = MapNames.ReplaceTemplateVars(Path.Combine(@"NECN", "SurfaceDuffBiomass-{timestep}.img"), PlugIn.ModelCore.CurrentTime);
